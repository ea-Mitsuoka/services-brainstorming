...
- **製品**：入口（#8 Sandbox／診断）→ **Pack A「BQ Data Trust」(#2 PII＋#3 アクセス統制)** → **Pack C「AI Trust」(#9 AIガバナンス＋#11 安全アクセス層)** → 運用MRR（#10 AI SOC）。Pack B Landing Zone(#7) は②エンタープライズ向けの**控え**。
- **武器**：共通IaCエンジンで「一度作って横展開」＝高粗利。
