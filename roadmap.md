...
- **期間／価格（例示）**：3〜6週 ／ 構築 ¥150〜400万（+ DLPスキャン量に応じ請求代行売上が上乗せ）
...
- **期間／価格（例示）**：3〜8週（「安全に運用できる状態まで3週間」を訴求） ／ 構築 ¥400〜1,200万
...
- **期間／価格（例示）**：「2週間でAI利用基盤を構築」メニュー ／ 構築 ¥600〜1,500万
...
### ユニットエコノミクス（工数 → 原価 → 推奨価格 → 粗利 ｜ すべて例示・要調整）

| メニュー | 区分 | 工数(人日) | 原価(¥) | 推奨販売価格(¥) | 粗利率 |
|---|---|:---:|:---:|:---:|:---:|
| データ安全性診断（PII） | — | 4 | 40万 | 0〜80万 ※入口の戦略的赤字を許容 | ▲100〜+50% |
| AI Ready Assessment（100項目） | — | 6 | 60万 | 80〜150万 | 25〜60% |
| Pack A：Data Trust | 初回 | 20 | 200万 | **300万〜** | 33%〜 |
| Pack A：Data Trust | 横展開 | 10 | 100万 | 250〜350万 | 60〜71% |
| Pack B：Landing Zone | 初回 | 40 | 400万 | **600万〜** | 33%〜 |
| Pack B：Landing Zone | 横展開 | 28 | 280万 | 500〜900万 | 44〜69% |
| Pack C：AI Trust | 初回 | 50 | 500万 | **800万〜** | 38%〜 |
| Pack C：AI Trust | 横展開 | 32 | 320万 | 600〜1,000万 | 47〜68% |
| 運用 Standard（MRR） | — | 1/月 | 10万/月 | 20〜30万/月 | 50〜67% |
| 運用 Advanced（MRR） | — | 2〜3/月 | 20〜30万/月 | 40〜50万/月 | 25〜50% |

> **価格フロアの見直し**：上の「パッケージ定義」表のレンジ下限（例：Pack A ¥150万）は**横展開時のみの下限**。**初回案件は原価割れ回避のため上表の太字フロア（Pack A ¥300万／B ¥600万／C ¥800万）以上**で握る。再利用が効く2社目以降で価格を下げても粗利が確保できる。

### 共通エンジンへの先行投資（非課金R&D ｜ 例示）

| 投資項目 | 工数(人日) | 金額(¥) | 時期 |
|---|:---:|:---:|---|
| PoC + リポジトリ骨格（`pii-protection`/`ci`） | 18 | 180万 | Phase 0 |
| Pack A モジュール群 製品化 | 25 | 250万 | Phase 1 |
| `landing-zone` モジュール 製品化 | 30 | 300万 | Phase 2 |
| `ai-governance`/`ai-safe-access` 製品化 | 35 | 350万 | Phase 3 |

> この投資は1回作れば全顧客に展開できる。**横展開3〜4社で回収**できる規模（例：Pack B モジュール¥300万 ÷ 横展開時粗利¥300万/社 ≒ 1社で回収）。

### 今期 売上・粗利イメージ（例示・保守シナリオ）

> あくまで受注ミックスの一例。実際の受注数で再計算する。

| 区分 | 内訳（例） | 売上(¥) | 原価(¥) |
|---|---|:---:|:---:|
| 診断 | 4社 × 50万 | 200万 | 160万 |
| Pack A 構築 | 初回1社350万 + 横展開2社550万 | 900万 | 400万 |
| Pack B 構築 | 初回1社800万 + 横展開1社600万 | 1,400万 | 680万 |
| 運用(MRR) | 3社 × 20万 × 平均3ヶ月 | 180万 | 90万 |
| **外販 計** | | **約2,680万** | **約1,330万** |
| 外販粗利 | | **約1,350万（粗利率 約50%）** | |
| R&D先行投資（今期分） | PoC180 + PackA250 + PackB300 | △730万 | |
| **投資後 利益（今期）** | | **約620万** | |

> 投資フェーズでも**横展開2社目以降の高粗利**で今期黒字化が狙える構造。来期はR&D投資が一巡し、横展開とMRR積み上げで粗利率がさらに改善する。
